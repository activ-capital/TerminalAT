...
Все статусы кроме success считаются неуспешными.
Это означает, что при получении любого из кодов выше операция считается завершённой с ошибкой и должна быть обработана как сбой.
